...
fq_raw_strata <- ruODK::odata_submission_get(
  table = fq_svc$name[2],
  parse = FALSE
)
...
fq_zip_strata <- fid_csv_veg %>%
  ...
  # ruODK::handle_ru_attachments(fq_form_schema, local_dir = t) %>% # no att.
...
usethis::use_data(fq_svc, overwrite = TRUE)
usethis::use_data(fq_meta, overwrite = TRUE)
usethis::use_data(fq_raw, overwrite = TRUE)
usethis::use_data(fq_raw_strata, overwrite = TRUE)
usethis::use_data(fq_raw_taxa, overwrite = TRUE)
usethis::use_data(fq_data, overwrite = TRUE)
usethis::use_data(fq_data_strata, overwrite = TRUE)
usethis::use_data(fq_data_taxa, overwrite = TRUE)

usethis::use_data(geo_fs, overwrite = TRUE)
usethis::use_data(geo_gj_raw, overwrite = TRUE)
usethis::use_data(geo_gj, overwrite = TRUE)
usethis::use_data(geo_wkt_raw, overwrite = TRUE)
usethis::use_data(geo_wkt, overwrite = TRUE)

usethis::use_data(fq_project_list, overwrite = TRUE)
usethis::use_data(fq_project_detail, overwrite = TRUE)
usethis::use_data(fq_form_list, overwrite = TRUE)
usethis::use_data(fq_form_xml, overwrite = TRUE)
usethis::use_data(fq_form_schema, overwrite = TRUE)
usethis::use_data(fq_form_detail, overwrite = TRUE)

usethis::use_data(fq_zip_data, overwrite = TRUE)
usethis::use_data(fq_zip_strata, overwrite = TRUE)
usethis::use_data(fq_zip_taxa, overwrite = TRUE)

usethis::use_data(fq_submission_list, overwrite = TRUE)
usethis::use_data(fq_submissions, overwrite = TRUE)
usethis::use_data(fq_attachments, overwrite = TRUE)
