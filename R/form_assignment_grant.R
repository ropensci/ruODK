#' Assign an Actor to a Form Role.
#'
...
#'   Central API docs.
# nolint start
#' @seealso \url{https://docs.getodk.org/central-api-form-management/#assigning-an-actor-to-a-form-role}
# nolint end
...
#' # > [1] TRUE
#' }
form_assignment_grant <- function(
  pid = get_default_pid(),
  fid = get_default_fid(),
  role_id,
  actor_id,
...
# usethis::use_test("form_assignment_grant")  # nolint
