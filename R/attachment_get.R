...
#' \lifecycle{stable}
#'
#' This is a helper function used by \code{`attachment_get()`}.
...
#' \lifecycle{stable}
#'
#' This is a helper function used by \code{`get_attachment()`}.
#' This function is not vectorised, but mapped by \code{`get_attachment()`}
