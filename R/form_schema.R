...
#' fs_nested <- form_schema(flatten = FALSE, odata = FALSE, parse = FALSE, odkc_version = 0.7)
#' listviewer::jsonedit(fs_nested)
#'
#' fs_flattened <- form_schema(flatten = TRUE, odata = FALSE, parse = FALSE, odkc_version = 0.7)
