#' Download one Draft Form attachment.
#'
#' `r lifecycle::badge("experimental")`
#'
#' To download a single file from a Draft Form, use this endpoint.
#'
#' @template param-pid
#' @template param-fid
...
# nolint start
#' @seealso \url{https://docs.getodk.org/central-api-form-management/#downloading-a-draft-form-attachment}
# nolint end
...
#'
#' path <- form_draft_attachment_download(fid = fid, filename = al$name[[1]])
#'
#' file.info(path)$size
#' }
form_draft_attachment_download <- function(
  pid = get_default_pid(),
  fid = get_default_fid(),
  filename,
  dest = NULL,
...
# usethis::use_test("form_draft_attachment_download")  # nolint
