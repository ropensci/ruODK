...
(online [here](https://ropensci.github.io/ruODK/articles/odata-api.html)) 
...
# Setup ruODK
See [`vignette("Setup", package = "ruODK")`](https://ropensci.github.io/ruODK/articles/setup.html) 
...
## Rectangling and parsing the submissions
...
dataframe, then sanitise the column names, handle datetimes, geopoints and 
attachments, like we did with the CSV export.

It appears this operation loses all but the last repeat of repeating groups.

<!-- TODO update and eval=T after #69 -->

```{r parse_submissions, eval=F}
...
attachments to build visualisations as shown in the 
[`vignette("odata-api", package="ruODK")`](https://ropensci.github.io/ruODK/articles/odata-api.html).

The best pathway to retrieve submission data seems to be the data export to ZIP 
or access via OData.
