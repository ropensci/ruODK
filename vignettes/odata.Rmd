...
into a clean `tibble` of field type and name. To know the names of fields of
a certain type will help us later to parse the submission data.
...
fq_taxa <- odata_submission_get(table = fq_svc$name[3])
```

The output of the above code is provided as data objects 
