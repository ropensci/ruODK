...
[![Hosted RStudio with ruODK](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/dbca-wa/urODK/master?urlpath=lab)
<!-- badges: end -->
...
[ruODK Docker image](https://github.com/ropensci/ruODK/pkgs/container/ruodk) or 
* build the image locally with your own GitHub Personal Access Token (PAT).
...
* RStudio Server running on <http://0.0.0.0:8787/> as user `rstudio` with a 
  chosen password (here: `ruodk`),
* with a Bash shell (from within you can run R or poke around in the system), or
* with an R shell.
...
If you don't want to install and run Docker yourself, you can use the hosted version on
[BinderHub](https://mybinder.readthedocs.io/) by clicking on  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/dbca-wa/urODK/master?urlpath=lab).
...
## Try ruODK
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/dbca-wa/urODK/master?urlpath=lab) 
will launch a disposable, hosted JupyterLab instance with `ruODK` installed and
