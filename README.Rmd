...
You can also run `ruODK` from the pre-built 
[ruODK Docker image](https://github.com/ropensci/ruODK/pkgs/container/ruodk) 
through RStudio Server or a plain Bash / R shell.
...
[BinderHub](https://mybinder.readthedocs.io/) on good days<sup>*</sup> by clicking on  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/dbca-wa/urODK/master?urlpath=rstudio).
