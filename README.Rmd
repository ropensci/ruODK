...
[OpenDataKit](https://opendatakit.org/) (ODK) is a free and open-source software for 
collecting, managing, and using data in resource-constrained environments.
...
and allows data collection clients like ODK Collect to connect to it for 
...
* To wrap "management" API endpoints. The ODK Central GUI provides a comprehensive 
  ...
  Behind the scenes, it is a [VueJS application](https://github.com/opendatakit/central-frontend/) 
