...
```
<!-- and restart the R session to load these environment variables. -->

<!-- 
* Configure ODK Central base URL, project ID, and form ID through OData Service URL.
  Paste the (non-sensitive) OData Service URL over `SVC_URL`.
...
data <- data_main_raw %>% 
  ...
  dplyr::rename(
    # # Inspect data, find colnames of coordinates (if any):
    # longitude = x13,
    # latitude = x14,
    # altitude = x15
  ) %>%
