...
| Test coverage \[%\]             | 100                                                                                                                          | 68                                                                                 | 0                                                                                  | 0                                                                 |
| Working examples                | README, vignettes, pkgdown                                                                                                   | README, pkgdown                                                                    | CRAN PDF                                                                           | README                                                            |
| Available on CRAN               | ❌                                                                                                                            | ✅                                                                                  | ✅                                                                                  | ❌                                                                 |
...
| Website                                         | GH\](<https://github.com/dbca-wa/ruODK>) [pkgdown](https://dbca-wa.github.io/ruODK/) | [GH](https://github.com/HanOostdijk/odataR)                | [CRAN](https://cran.r-project.org/web/packages/cbsodataR/) [GH](https://github.com/edwindj/cbsodataR) [pkgdown](https://edwindj.github.io/cbsodataR/) | OData                                                             | odatajdbcr                                                              |
| Test coverage \[%\]                             | 100                                                                                  | 68                                                         | 0                                                                                                                                                     | 0                                                                 | 0                                                                       |
| Targets ODK Central                             | ✅                                                                                    | ❌                                                          | ❌                                                                                                                                                     | ❌                                                                 | ❌                                                                       |
| Works with ODK Central                          | ✅                                                                                    | ❓                                                          | ❓                                                                                                                                                     | ❌                                                                 | ❌                                                                       |
| Actively maintained to work against ODK Central | ✅                                                                                    | ❌                                                          | ❌                                                                                                                                                     | ❌                                                                 | ❌                                                                       |
| Technologies                                    | R, httr, xml2, tidyr                                                                 | R, jsonlite, tidyverse                                     | R, tidyverse                                                                                                                                          | R, XML, RJSONIO                                                   | R, RJDBC, Java                                                          |
| External dependencies                           | ❌                                                                                    | ❌                                                          | ❌                                                                                                                                                     | ❌                                                                 | JDBC, Java                                                              |
| Available on CRAN                               | ❌                                                                                    | ❌                                                          | ✅                                                                                                                                                     | ✅                                                                 | ❌                                                                       |
